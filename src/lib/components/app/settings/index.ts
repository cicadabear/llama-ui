...
/**
 * API endpoint field for the General settings section. Lets the user point the
 * UI at a custom OpenAI-compatible backend (e.g. a vllm server); applying it
 * persists the base to localStorage and reloads the app.
 */
export { default as SettingsChatApiEndpoint } from './SettingsChat/SettingsChatApiEndpoint.svelte';
